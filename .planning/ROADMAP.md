...
Plans:
- [ ] 13-01: GetSongBPM API client, song model, half/double-time matching logic, and unit tests
- [ ] 13-02: Local BPM cache (SharedPreferences), cache-first lookup strategy, error handling, and provider integration
