...
<task type="auto">
  ...
  <action>
Create `assets/curated_songs.json` with 300+ curated running songs (target: 300-400 for good genre coverage; CURA-01 requires 200-500). Each song is a JSON object with camelCase keys matching CuratedSong.fromJson:
...
**Genre distribution requirements** -- at least 15 songs per genre (300 / 15 = 20 target), covering all 15 RunningGenre enum values:
...
4. Each genre has at least 15 songs
